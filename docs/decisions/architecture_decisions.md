...
- **Not yet done**: finish the Phase 3 burn-in period (let it run, watch `OPN-WAN` for stability over time), Phase 4 (actual cutover of this host's own traffic to route via OPNsense).
